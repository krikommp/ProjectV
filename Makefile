...
UNREALROOTPATH = /home/chenyifei/UnrealEngine
GAMEPROJECTFILE =/home/chenyifei/UnrealPrjects/ProjectV/ProjectV.uproject
...
TARGETS = \
	...
	UnrealServer \
	ProjectVEditor-Linux-Debug  \
	ProjectVEditor-Linux-DebugGame  \
	ProjectVEditor-Linux-Test  \
	ProjectVEditor-Linux-Shipping  \
	ProjectVEditor \
	ProjectVGame-Linux-Debug  \
	ProjectVGame-Linux-DebugGame  \
	ProjectVGame-Linux-Test  \
	ProjectVGame-Linux-Shipping  \
	ProjectVGame\
	configure
...
StandardSet: RequiredTools UnrealFrontend ProjectVEditor UnrealInsights

DebugSet: RequiredTools UnrealFrontend-Linux-Debug ProjectVEditor-Linux-Debug
...
ProjectVEditor-Linux-Debug:
	 $(PROJECTBUILD) ProjectVEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

ProjectVEditor-Linux-DebugGame:
	 $(PROJECTBUILD) ProjectVEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

ProjectVEditor-Linux-Test:
	 $(PROJECTBUILD) ProjectVEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

ProjectVEditor-Linux-Shipping:
	 $(PROJECTBUILD) ProjectVEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

ProjectVEditor:
	 $(PROJECTBUILD) ProjectVEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

ProjectVGame-Linux-Debug:
	 $(BUILD) ProjectVGame Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

ProjectVGame-Linux-DebugGame:
	 $(BUILD) ProjectVGame Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

ProjectVGame-Linux-Test:
	 $(BUILD) ProjectVGame Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

ProjectVGame-Linux-Shipping:
	 $(BUILD) ProjectVGame Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

ProjectVGame:
	 $(BUILD) ProjectVGame Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
