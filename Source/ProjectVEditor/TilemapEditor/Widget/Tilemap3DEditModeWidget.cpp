...
void STilemap3DEditModeWidget::Construct(const FArguments& InArgs)
{
	...
	[
		...
		[
			...
			.Visibility_Lambda([this](){ return BaseEditMode.Get() == EEM_Cube ? EVisibility::Visible : EVisibility::Collapsed; })
			[
		...
		[
			SNew(SBorder)
			.BorderImage(FAppStyle::GetBrush("Docking.Tab.ContentAreaBrush"))
			.Visibility_Lambda([this](){ return BaseEditMode.Get() == EEM_Mesh ? EVisibility::Visible : EVisibility::Collapsed; })
			[
