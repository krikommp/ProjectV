...
UGridExperienceDefinition::UGridExperienceDefinition()
{
}

#if WITH_EDITOR
EDataValidationResult UGridExperienceDefinition::IsDataValid(TArray<FText>& ValidationErrors)
{
...
void UGridExperienceDefinition::UpdateAssetBundleData()
{
