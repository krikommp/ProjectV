...
#else
	case EGridWidgetInputMode::GameAndMenu:
		return FUIInputConfig(ECommonInputMode::All, GameMouseCaptureMode, bShowCursor);
	case EGridWidgetInputMode::Game:
		return FUIInputConfig(ECommonInputMode::Game, GameMouseCaptureMode, bShowCursor);
	case EGridWidgetInputMode::Menu:
		return FUIInputConfig(ECommonInputMode::Menu, EMouseCaptureMode::NoCapture);
	case EGridWidgetInputMode::Default:
	default:
                                                        ...
                                                        IWidgetCompilerLog& CompileLog) const
{
	...
	if (!GetClass()->IsFunctionImplementedInScript(
		GET_FUNCTION_NAME_CHECKED(UGridActivatableWidget, BP_GetDesiredFocusTarget)))
	{
